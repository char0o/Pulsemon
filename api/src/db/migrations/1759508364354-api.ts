...
export class Api1759508364354 implements MigrationInterface {
    name = 'Api1759508364354'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."organization_member_role_enum" AS ENUM('0', '1', '2')`);
        await queryRunner.query(`CREATE TABLE "organization_member" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "deletedById" integer, "userId" integer NOT NULL, "organizationId" integer NOT NULL, "joinedAt" TIMESTAMP NOT NULL DEFAULT now(), "role" "public"."organization_member_role_enum" NOT NULL, CONSTRAINT "PK_42e917807d7bb6b1144f14ef4f0" PRIMARY KEY ("id", "userId", "organizationId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "endpoint" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "path" character varying NOT NULL, "method" "public"."endpoint_method_enum" NOT NULL, "description" character varying, "apiId" integer, CONSTRAINT "PK_7785c5c2cf24e6ab3abb7a2e89f" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "organization_member" ADD CONSTRAINT "FK_1eb787f3c820ab2e58b7204f765" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
